...
public class AdopetConsoleApplication {
    ...
    private static void registrarRefugio() throws IOException, InterruptedException {
    ...
    private static void listarMascotasDelRefugio() throws IOException, InterruptedException {
